...
class PhocaGalleryCpControllerPhocaGalleryProduct extends JControllerForm
{
	...
	*/
	...
	public function batch() {
		...
		// Set the model
		$model	= $this->getModel('phocagalleryproduct', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_phocagallery&view=phocagalleryproducts'.$this->getRedirectToListAppend(), false));
