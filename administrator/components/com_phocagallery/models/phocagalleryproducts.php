...
class PhocaGalleryCpModelPhocaGalleryProducts extends JModelList
{
...
*/
		...
		$catname = $app->getUserStateFromRequest($this->context.'.filter.catname', 'filter_catname', null);
		$this->setState('filter.catname', $catname);
	...
	protected function getListQuery()
	{
		...
		*/
		...
		$query->from('`#__phocagallery_products` AS a');
...
*/
		...
		$query->join('LEFT', '#__phocagallery_tags_products_view AS tg ON tg.imgid = a.id');
		...
		$catname = $this->getState('filter.catname');
		if ($catname!='') {
			$query->where('a.catname = \'' . $catname.'\'');
		}
