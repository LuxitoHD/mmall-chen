...
<form action="<?php echo JRoute::_('index.php?option=com_phocagallery&view=phocagalleryproducts'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_catname" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY');?></option>
				<option value="团购" <?php if ($this->state->get('filter.catname')=='团购') echo 'selected="selected" '?>>团购</option>
				<option value="闪购" <?php if ($this->state->get('filter.catname')=='闪购') echo 'selected="selected" '?>>闪购</option>
				<option value="商城" <?php if ($this->state->get('filter.catname')=='商城') echo 'selected="selected" '?>>商城</option>
			</select>
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="1%" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'COM_PHOCAGALLERY_FIELD_PRODUCT_GET_URL_LABEL', 'a.source',$listDirn, $listOrder); ?>
					</th>
					<th width="12%" nowrap="nowrap"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_FILENAME1', 'a.filename',$listDirn, $listOrder ); ?>
					</th>
					

					<th width="15%"  class="title">
						<?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_CATEGORY1', 'category_id',$listDirn, $listOrder ); ?>
					</th>
...
$linkEdit 		= JRoute::_( 'index.php?option=com_phocagallery&task=phocagalleryproduct.edit&id='. $item->id );
