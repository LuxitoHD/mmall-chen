...
if ($user->authorise('core.manage', 'com_content'))
{
	...
	$menu->addChild(new JMenuNode(JText::_('COM_PHOCAGALLERY_CATEGORIES1'),'index.php?option=com_phocagallery&view=phocagalleryproducts','components/com_phocagallery/assets/images/icon-16-pg-menu-gal.png'));
